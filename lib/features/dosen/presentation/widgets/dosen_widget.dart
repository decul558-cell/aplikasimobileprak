      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.people_outline_rounded, size: 64, color: Color(0xFF9E9E9E)),
          ),
          const SizedBox(height: 24),
          const Text('Tidak ada data dosen',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Color(0xFF616161))),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: gradientColors[0].withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 4))],
                  ),
                  child: Center(
                    child: Text(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(color: gradientColors[0].withOpacity(0.1), borderRadius: BorderRadius.circular(12)),
                  child: Icon(Icons.arrow_forward_ios_rounded, size: 16, color: gradientColors[0]),
                ),
              ],
            ),
          ),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(dosen.name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 4),
                    Text('@${dosen.username}', style: TextStyle(fontSize: 13, color: Colors.grey[600])),
                    Text(dosen.email, style: TextStyle(fontSize: 13, color: Colors.grey[600])),
